...
%define pkgrelease 70.5.1.el9_0

# This is needed to do merge window version magic
%define patchlevel 14

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 70.5.1%{?buildid}%{?dist}
...
Source0: linux-5.14.0-70.5.1.el9_0.tar.xz
...
%setup -q -n kernel-5.14.0-70.5.1.el9_0 -c
mv linux-5.14.0-70.5.1.el9_0 linux-%{KVERREL}
