...
%define pkgrelease 0.rc6.92

# This is needed to do merge window version magic
%define patchlevel 10

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 0.rc6.92%{?buildid}%{?dist}
...
Source0: linux-5.10.0-0.rc6.92.tar.xz
...
%setup -q -n kernel-5.10.0-0.rc6.92 -c
mv linux-5.10.0-0.rc6.92 linux-%{KVERREL}
