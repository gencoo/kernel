...
%define pkgrelease 86.el9

# This is needed to do merge window version magic
%define patchlevel 14

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 86%{?buildid}%{?dist}
...
Source0: linux-5.14.0-86.el9.tar.xz
...
%setup -q -n kernel-5.14.0-86.el9 -c
mv linux-5.14.0-86.el9 linux-%{KVERREL}
